---
name: web
description: Expert-level web development specializing in React 19, Vite, and modern front-end architecture within monorepos.
trigger: /web
---

## Use this skill when

- Developing or maintaining React web applications.
- Configuring Vite, TypeScript, or build tooling.
...
- You are working on mobile (use `mobile` skill instead).

## Instructions

- Prioritize React 19 patterns and hooks.
- Follow the premium design aesthetics: vibrant colors, dark modes, smooth transitions.
- Use Vanilla CSS or CSS Modules for maximum flexibility and performance.
- Ensure strict TypeScript compliance and monorepo integration.
...
- **Animations**: Using Framer Motion or CSS transitions for smooth micro-interactions.
...
4. **Integration**: Ensure the feature correctly utilizes shared monorepo packages.
...
- "Optimize our web bundle size by analyzing the Vite build report."
- "Set up a shared TypeScript type system across the web and mobile workspaces."
