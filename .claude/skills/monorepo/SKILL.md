---
name: monorepo
description: Expert-level monorepo architecture and management, covering build systems, dependency sharing, workspace isolation, and CI/CD pipeline optimization.
trigger: /monorepo
---
