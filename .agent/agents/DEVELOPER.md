...
- Follow all standard naming and template guidelines from `.agent/skills/jira/JIRA.md` (e.g., prefixing `[Web]`, `[Mobile]`, or `[Core]` to the title, and applying the corresponding label).

### 3. Create Commit
- After the Jira ticket is successfully created, initiate the commit process.
- Follow the rules defined in `.agent/skills/commit/COMMIT.md`.
...
- Follow the rules defined in `.agent/skills/pr/PR.md`.
