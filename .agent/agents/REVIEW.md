...
- **PR Metadata**: Verify that the PR title and description follow the templates defined in `.agent/skills/pr/PR.md`.
...
3. Execute the `jira-pr-merged` skill steps from `.agent/skills/pr/PR.md` to update the associated Jira ticket.
