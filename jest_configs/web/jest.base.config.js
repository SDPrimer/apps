module.exports = {
  ...
  moduleNameMapper: {
    ...
    '\\.(css|less|scss|sass)$': '<rootDir>/jest_configs/web/__mocks__/styleMock.js',
    '\\.(jpg|jpeg|png|gif|svg|webp|ttf|woff|woff2|eot)$': '<rootDir>/jest_configs/web/__mocks__/fileMock.js',
  },
  setupFiles: [
    // Setup files if any
  ],
